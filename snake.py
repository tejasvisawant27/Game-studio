...
#btn = Button(text="Back",font=('Times 40 bold'),height=1,width=15,bg='green',fg="cornsilk", command=welcome_window)
...
ttk.Button(buttons, text='Back', command=game.welcome_window).grid()
buttons.grid(column=0, row=0)

  
scoreboard = Frame(root, width=40, height=4*HT/5,bg='white')
