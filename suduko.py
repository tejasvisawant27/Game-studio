...
title = Label(root, text='Sudoku', fg="#382888",font="Geneva 30")
title.pack()

box = Canvas(root, width = 435, height = 435,bd=6, highlightthickness=6)  
box.pack()
...
def su():
    root.destroy()
    import Welcome
#b1=Button(text='quit game',command=su,fg="#282828",font="Geneva 30 bold",bg='#FCD4D4',activebackground='#FCD4D4',highlightbackground="#FCD4D4",disabledforeground="#FCD4D4",justify=LEFT,pady=2)
#b1.place(x=1000,y=575)
...
but = Canvas(root, width = 500, height = 45,bd=13, highlightthickness=0)  
but.pack()
enter = Button(but,text ="Submit", fg="#282828",command=submit, font="Geneva 30 bold",bg='#382888',activebackground='#382888',highlightbackground="#382888",disabledforeground="#382888",justify=CENTER)
enter.configure(bg='#382888',width = 12)
...
solve = Button(root,text ="Solve", fg="#282828",command=pressed_solve, font="Geneva 30 bold",bg='#FCD4D4',activebackground='#FCD4D4',highlightbackground="#FCD4D4",disabledforeground="#FCD4D4",justify=LEFT,pady=2)
solve.configure(bg='#FCD4D4',width = 8)
quit = Button(root,text ="quit", fg="#282828",command=su, font="Geneva 30 bold",bg='#FCD4D4',activebackground='#FCD4D4',highlightbackground="#FCD4D4",disabledforeground="#FCD4D4",pady=2)
#quit.configure(bg='#FCD4D4',width = 8)
quit.place(x=1000,y=575)
